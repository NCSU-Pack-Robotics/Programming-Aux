...
class sfDevOTOS
{
  ...
  protected:
    /** Virtual function that must be implemented by the derived class to delay for a given number of milliseconds */
    ...
    /** Conversion factors from meters and radians to the current linear and angular units */
    float _meterToUnit;
    float _radToUnit;
